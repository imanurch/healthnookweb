...
<body class="mx-[6rem] my-[3rem]">
    ...
    <div id="#katalog">
        ...
        <div class="flex space-x-5 mt-2">
            <a href="\" class="grid justify-items-center py-2.5 w-28 rounded {{ ($products->first()->jenisproduct->id_kategori !== "0")? 'bg-primary-600 text-neutral-0' : 'border border-neutral-200 text-neutral-800'}}">
                <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M44.7916 25C44.7916 36.5059 36.5059 44.7917 25 44.7917C13.494 44.7917 5.20831 36.5059 5.20831 25C5.20831 13.4941 13.494 5.20833 25 5.20833C36.5059 5.20833 44.7916 13.4941 44.7916 25Z" stroke="{{ ($products->first()->jenisproduct->id_kategori !== "0")? '#FFF' : '#4F4F4F'}}" stroke-width="2.08333"/>
                    <path d="M21.292 16.1909C21.0937 16.6695 21.0937 17.2762 21.0937 18.4896V20.9687C21.0937 21.0277 21.0937 21.0571 21.0754 21.0754C21.0571 21.0937 21.0277 21.0937 20.9687 21.0937H18.4896C17.2762 21.0937 16.6695 21.0937 16.1909 21.292C15.5528 21.5563 15.0459 22.0632 14.7815 22.7013C14.5833 23.1799 14.5833 23.7866 14.5833 25C14.5833 26.2134 14.5833 26.8201 14.7815 27.2986C15.0459 27.9367 15.5528 28.4437 16.1909 28.708C16.6695 28.9062 17.2762 28.9062 18.4896 28.9062H20.9687C21.0277 28.9062 21.0571 28.9062 21.0754 28.9246C21.0937 28.9429 21.0937 28.9723 21.0937 29.0312V31.5104C21.0937 32.7238 21.0937 33.3305 21.292 33.8091C21.5563 34.4472 22.0632 34.9541 22.7013 35.2184C23.1799 35.4167 23.7866 35.4167 25 35.4167C26.2134 35.4167 26.8201 35.4167 27.2986 35.2184C27.9367 34.9541 28.4437 34.4472 28.708 33.8091C28.9062 33.3305 28.9062 32.7238 28.9062 31.5104V29.0312C28.9062 28.9723 28.9062 28.9429 28.9245 28.9246C28.9428 28.9062 28.9723 28.9062 29.0312 28.9062H31.5104C32.7238 28.9062 33.3305 28.9062 33.8091 28.708C34.4471 28.4437 34.9541 27.9367 35.2184 27.2986C35.4166 26.8201 35.4166 26.2134 35.4166 25C35.4166 23.7866 35.4166 23.1799 35.2184 22.7013C34.9541 22.0632 34.4471 21.5563 33.8091 21.292C33.3305 21.0937 32.7238 21.0937 31.5104 21.0937H29.0312C28.9723 21.0937 28.9428 21.0937 28.9245 21.0754C28.9062 21.0571 28.9062 21.0277 28.9062 20.9687V18.4896C28.9062 17.2762 28.9062 16.6695 28.708 16.1909C28.4437 15.5528 27.9367 15.0459 27.2986 14.7816C26.8201 14.5833 26.2134 14.5833 25 14.5833C23.7866 14.5833 23.1799 14.5833 22.7013 14.7816C22.0632 15.0459 21.5563 15.5528 21.292 16.1909Z" stroke="{{ ($products->first()->jenisproduct->id_kategori !== "0")? '#FFF' : '#FF91A4'}}" stroke-width="2.08333"/>
                    </svg>                    
                <p>Semua</p>
            </a>
